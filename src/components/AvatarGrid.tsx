  ...
  <div className="mb-12">
    ...
    <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-12 gap-4">
      {characters.map((char, index) => (
        <Link key={char} href={`/avatar/${encodeURIComponent(char)}`} passHref>
          <div
            className="group relative aspect-square opacity-0 animate-fade-in cursor-pointer flex items-center justify-center rounded-lg transition-transform duration-300 transform hover:scale-105"
            style={{ 
